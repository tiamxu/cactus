...
func GetUsersByIDs(ids []int) ([]model.User, error) {
...
// List 用户列表
func List(page, pageSize int) ([]*model.User, error) {
	query := `
...
func GetUsersByCondition(gender, enable, username string, limit, offset int) ([]model.User, int64, error) {
	var users []model.User
	var total int64
