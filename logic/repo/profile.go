...
// 查询用户详情
func GetProfileByUserID(userId int) (*model.Profile, error) {
...
func GetProfilesByUserIDs(userIds []int) ([]model.Profile, error) {
...
func GetProfilesByCondition(gender, enable, username string, pageNo, pageSize int) ([]*model.Profile, int64, error) {
...
func UpdateProfileByWhere(p model.Profile) error {
	query := `
        UPDATE profile
        SET gender = :gender, 
            address = :address, 
